...
public class VisualiserPanel extends JPanel {
    ...
    private final BrushManagerService brushManager;
    private final PixelGridService grid;
    private final int w,h;

    public VisualiserPanel(PixelGridService grid, BrushManagerService brushManager, int w, int h){
        setSize(w,h);
        this.grid = grid;
        this.w = w;
        this.h = h;
    ...
    private void draw(Graphics2D g) throws RemoteException {
